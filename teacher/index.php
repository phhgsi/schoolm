...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="classes.php" class="bg-white p-8 rounded-lg shadow-md text-center">
                <h3 class="text-xl font-bold mb-4">My Classes & Subjects</h3>
            </a>
            ...
            <a href="marks.php" class="bg-white p-8 rounded-lg shadow-md text-center">
                <h3 class="text-xl font-bold mb-4">Enter Marks</h3>
            </a>
        </div>
    </div>
</body>
