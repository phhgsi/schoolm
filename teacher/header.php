...
<div class="flex">
    ...
    <div class="w-64 bg-gray-800 text-white h-screen">
        <div class="p-4">
            ...
            <ul>
                <li class="mb-2"><a href="<?php echo BASE_URL; ?>teacher/index.php" class="block p-2 rounded hover:bg-gray-700"><i class="fas fa-tachometer-alt mr-2"></i>Dashboard</a></li>
                <li class="mb-2"><a href="<?php echo BASE_URL; ?>teacher/classes.php" class="block p-2 rounded hover:bg-gray-700"><i class="fas fa-school mr-2"></i>Classes</a></li>
                <li class="mb-2"><a href="<?php echo BASE_URL; ?>teacher/attendance.php" class="block p-2 rounded hover:bg-gray-700"><i class="fas fa-calendar-check mr-2"></i>Attendance</a></li>
                <li class="mb-2"><a href="<?php echo BASE_URL; ?>teacher/marks.php" class="block p-2 rounded hover:bg-gray-700"><i class="fas fa-file-alt mr-2"></i>Marks</a></li>
            </ul>
        </div>
    </div>
